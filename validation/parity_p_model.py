...
Run from repo root:
  PYTHONPATH=/path/to/EQCCT_to_Seisbench python -m validation.parity_p_model
...
(matched to ~1e-7 here), run ``python -m validation.p_model_onnx`` (see that
...
def _verify_tf_p_weights_match_disk(model_p_tf, p_h5: Path) -> tuple[bool, str]:
    ...
    from conversion.loader import flat_torchish_from_h5
...
def main(argv=None) -> int:
    ...
    from conversion.catalog import assert_and_print
